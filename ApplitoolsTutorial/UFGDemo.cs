...
namespace ApplitoolsTutorial
{
    ...
    public class UFGDemo
    {
		...
		public void BeforeEach() {
			...
			config.SetBatch(new BatchInfo("full page Batch"));
		...
		public void UFGTest(){
            ...
            eyes.Open(driver, "Full page App - csharp ufg", "Full page Test", new Size(800, 600));

            // Navigate the browser to the "ACME" demo app. To see visual bugs after the first run, use the commented line below instead.
            driver.Url = "https://en.wikipedia.org/wiki/HTTP_cookie#Cross-site_scripting:_cookie_theft";
            ...
            eyes.Check(Target.Window().Fully().WithName("Wiki page"));
